...
namespace Led5KSDKDemoCSharp
{
    public partial class Area : Form
    {
        ...
        {
            bx_5k.DynamicAreaLoc = Convert.ToByte(numericUpDown1.Value);
            bx_5k.AreaType = 0x00;
            if (Form1.type >= 6)
            {
                bx_5k.AreaX = (ushort)(Convert.ToUInt16(textBox1.Text) | 0x8000);
                bx_5k.AreaWidth = (ushort)(Convert.ToUInt16(textBox3.Text) | 0x8000);
            }
            else
            {
